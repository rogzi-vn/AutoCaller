...
class DatabaseContext(val context: AppCompatActivity) : SQLiteOpenHelper(
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        // Chạy lệnh tạo bảng
        db?.execSQL("CREATE TABLE IF NOT EXISTS \"${CampaignModel.TABLE_NAME}\" (\n" +
                ...
                ");")
        db?.execSQL("CREATE TABLE IF NOT EXISTS \"${CampaignDataModel.TABLE_NAME}\" (\n" +
